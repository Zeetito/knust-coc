<form action="{{route('mark_user_inactive',['user'=>$user])}}" method="post">
    @csrf
        ...
        <div class="modal-body">
                ...
                <div calss="form-group">
                    <label class="form" for="is_activated">Change Account Status</label>
                    <select class="form-control" name="is_activated" required id="is_activated">
