<form action="{{route('remove_role_permission',['role'=>$role, 'permission'=>$permission])}}" method="post">
        @csrf
        @method('delete')
            ...
            <div class="modal-body">
                {{-- User Name --}}
                <p>Are you sure you want to <strong>withdraw</strong> this Permission from   "{{$role->name}}"  </p>
