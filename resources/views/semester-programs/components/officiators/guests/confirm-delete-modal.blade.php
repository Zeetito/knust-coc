...
<form action="{{route('remove_officiator',['semesterProgram'=>$semesterProgram, 'officiator'=>$officiator , 'status'=>$status, 'role'=>$role])}}" method="post">
    ...
    @csrf
        ...
        <div class="modal-body">
            {{-- User Name --}}
            <p>Are you sure you want to withdraw this role from {{App\Models\Guest::find($officiator)->fullname}}  </p>
    ...
    <div class="modal-footer">
        <input type="submit" name="submit_guest" value="Yes" class="form-control btn btn-secondary">  
