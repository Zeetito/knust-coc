...
class ResidenceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // CAMPUS 3
            ["name"=>"Africa Hall", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"Baby Brunei", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"Brunei Complex", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"Chancellor's Hall (Hall 7)", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"Impact Building", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"Independence Hall (Indece)", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"Queen Elizabeth II (Queens Hall)", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"Spring Hostel", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"SRC Hostel", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ...
            ["name"=>"Unity Hall (Conti)", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
            ["name"=>"University Hall", "zone_id"=>3, "description"=>"none", "landmark"=>"none"],
